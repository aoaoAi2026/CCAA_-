        ...
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center gap-2">
            ...
            <template v-if="isLoggedIn">
              <router-link
                to="/profile"
                class="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-blue-50 dark:bg-slate-700 text-blue-700 dark:text-blue-300 text-sm hover:bg-blue-100 dark:hover:bg-slate-600 transition"
              >
              ...
              <button
                @click="handleLogout"
                class="px-3 py-1.5 text-sm text-gray-600 dark:text-slate-300 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 transition"
              >
                退出
              </button>
            </template>
...
import {
  Sun as HomeIcon, BookOpen, Play, Target, AlertCircle, Gamepad2, TrendingUp, FolderOpen, User, Moon, Sun
